...
public class UnMaskedController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        CharacterManager.Instance.unMaskedCharacters.Add(gameObject);
        waitTime = startWaitTime;
        affector = Resources.Load("Affectors/UnMaskedAffector") as GameObject;
        goalLocations = GameObject.FindGameObjectsWithTag("UnMaskedGoal");
    ...
    void OnDestroy()
    {
        ...
        CharacterManager.Instance.unMaskedCharacters.Remove(gameObject);
    }
