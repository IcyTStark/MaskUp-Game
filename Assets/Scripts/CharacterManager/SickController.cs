...
public class SickController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        CharacterManager.Instance.sickCharacters.Add(gameObject);
        waitTime = startWaitTime;
        goalLocations = GameObject.FindGameObjectsWithTag("SickGoals");
        affector = Resources.Load("Affectors/SickAffector") as GameObject;
